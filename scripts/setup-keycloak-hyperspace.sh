...
./functions/add-composite-role.sh "$REALM" "$ORGANISATION_ADMIN_ROLE_ID" "realm-management" "query-clients"
./functions/add-composite-role.sh "$REALM" "$ORGANISATION_ADMIN_ROLE_ID" "realm-management" "view-realm"
./functions/add-composite-role.sh "$REALM" "$ORGANISATION_ADMIN_ROLE_ID" "realm-management" "manage-users"
